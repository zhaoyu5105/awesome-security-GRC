...
Awesome-security-GRC 是一个用来聚集安全GRC的知识存储库，为安全治理、风险管理、安全合规和安全审计的专业人士提供精选的资源列表。同时欢迎大家一起对安全GRC资源列表进行贡献与补充。
...
审计和合规（compliance ）：审计和合规，负责跟踪监管环境、监视控制，以确保持续合规，促进合规审计。
审计是您知道您选择的安全控制和安全程序是否有效运行；
合规是遵守规则、法律和法规的行为，与监管部门或者第三方机构的设定基线的接近程度。

对与安全合规相关的法律法规、行业标准及相关规范性文件，笔着本人也在跟踪和统计，方便查询和适用。

[跟踪国内外信息安全的法律法规、行业标准、监管要求等相关资讯，提供一个可查询的信息安全合规平台](https://zhaoyu5105.github.io/)
